package com.ruoyi.common.utils.autoId;
...
public class WorkerIdUtil {
     ...
     *
     **/
    public static Long getHostNameWorkerId() {
        InetAddress address;
        Long workerId;
        try {
     ...
     */
    public static Long getIPWorkerId() {
        InetAddress address;
        try {
    ...
    /**
     * 浏览 orkerId生成的规则后，感觉对服务器IP后10位（特别是IPV6）数值比较约束.
     *
     * <p>
     * 有以下优化思路：
     ...
     *
     */
    public static Long getIPSectionWorkerId() {
        InetAddress address;
        try {
            address = InetAddress.getLocalHost();
        } catch (final UnknownHostException e) {
